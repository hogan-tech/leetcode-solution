<h2><a href="https://leetcode.com/problems/longest-absolute-file-path/">388. Longest Absolute File Path</a></h2><h3>Medium</h3><hr><div><p>Suppose we have a file system that stores both files and directories. An example of one system is represented in the following picture:</p>
